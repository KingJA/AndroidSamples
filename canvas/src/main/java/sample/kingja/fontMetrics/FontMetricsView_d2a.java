 ...
 */
public class FontMetricsView_d2a extends View {
    ...
    public FontMetricsView_d2a(Context context) {
        super(context);

    }

    public FontMetricsView_d2a(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        fontHeight = bottom - top;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        baseY = measuredHeight * 0.5f+(0.5f*fontHeight-descent);

//        float offsetY=0.5f*fontHeight-descent;
//        baseY+=offsetY;
        fontMiddleY = baseY + ascent + 0.5f * fontHeight;
    }
