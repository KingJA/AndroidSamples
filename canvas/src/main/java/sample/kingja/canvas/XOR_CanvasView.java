 ...
 */
public class XOR_CanvasView extends View {
    private static final String TAG = "CanvasView";
    private int size;
    private Paint circlePaint;
    private Paint clipPaint;

    public XOR_CanvasView(Context context) {
        this(context, null);
    }

    public XOR_CanvasView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XOR_CanvasView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.clipRect(0,0,0.5f*size,0.5f*size, Region.Op.XOR);//在绘图之前调用
